...
function Util(dapper) {
  ...
  self.validatePasswordMFA = function(password, token, actualPassword, actualMFA) {
    return self.ensureSecure(password) === actualPassword && self.validateToken(token, actualMFA);
  };

...
function APIServer(dapper) {
  ...
  dapper.api.get('/api/datastore', dapper.sessions.validate, (req, res, next) => {
  ...
  dapper.api.get('/api/domains', dapper.sessions.validate, (req, res, next) => {
    const result = {
      items: [],
      count: 0
    };
  ...
  dapper.api.get('/api/organizations', dapper.sessions.validate, (req, res, next) => {
    const result = {
      items: [],
      count: 0
    };
  ...
  dapper.api.get('/api/groups', dapper.sessions.validate, (req, res, next) => {
    const result = {
      items: [],
      count: 0
    };
  ...
  dapper.api.get('/api/users', dapper.sessions.validate, (req, res, next) => {
    const result = {
      items: [],
      count: 0
    };
